module pain_classification_engine #(
    ...
    input  wire                     clk,
    input  wire                     reset,
    input  wire [input_width*3-1:0] feature_vector,
    ...
    assign alpha_feature = feature_vector[(input_width*3)-1:(input_width*2)];
    assign beta_feature  = feature_vector[(input_width*2)-1:input_width];
    assign theta_feature = feature_vector[input_width-1:0];
